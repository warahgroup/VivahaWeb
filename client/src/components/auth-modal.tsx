    ...
    googleSignInMutation.mutate(undefined, {
      onSuccess: (response) => {
        if (response.success && response.user) {
          ...
          trackEvent("google_signin", "auth", "success");
          ...
          trackEvent("google_signin", "auth", "error", response.message);
        }
      },
      onError: (error) => {
        toast({
        ...
        trackEvent("google_signin", "auth", "error");
      },
    });
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Sign in with your Google account to access your personalized wedding planning dashboard
          </DialogDescription>
        </DialogHeader>
