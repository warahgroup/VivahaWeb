...
export function MockLogin({ onSuccess }: MockLoginProps) {
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Sign in with your Google account to test the Vivaha wedding planning app
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <Alert className="mt-6">
              <AlertDescription>
                <strong>Note:</strong> This is a test login page. Sign in with your Google account to access the app.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
